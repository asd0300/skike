...
payload = json.dumps({
  ...
  "variables": {
    "request": {
      ...
      "criteriaToken": "tripType:OW|criteriatoken:KLUv_QBQSQIACwgBEJSoARjTggMggIip6NgvDBMIARABGAEUGAMgASgLMAFDKAAwADgAQABIAFAAgAEAkAEAqAEAuAEA0gEBMkRIAFAAYNSLAQ==|cabinClass:YSGroup|adult:1|dCity_1:TPE|aCity_1:SEL|date_1:2021-12-06|idc:SHARB|extensionflag:1",
      "lowPrice": 35504,
