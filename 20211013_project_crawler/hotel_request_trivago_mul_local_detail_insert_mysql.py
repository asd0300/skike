...
for i in results:
    ...
    for hotel_product in i['accommodations']:
        ...
        agency_data_list =[]
    print("start insert hotel to skike.hotel")
    ...
    for item in sql_all_hotel_id:
        print(item)
        print(item['data_query_time'],type(item['data_query_time']))
        time_format ="%Y%m%d"
        try:
            dt_start = datetime.datetime.strptime(item['data_query_time'], time_format)
            print(dt_start.date())
        except Exception as e:
            print("Exeception occured:{}".format(e))
        dt_next_day = dt_start+ timedelta(days =1)
        ...
        "variables": {
            ...
            "stayPeriod": {
                "arrival": dt_start.date(),
                "departure": dt_next_day.date()
            },
            "rooms": [
                {
                "adults": 1,
        ...
        try:
            ...
            print(str(dt_start.date())+" ip is "+str(ip))
