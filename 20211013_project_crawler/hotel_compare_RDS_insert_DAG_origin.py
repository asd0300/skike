...
def hotel_compare_RDS_insert_DAG():
    ...
    for KR_item in KR_land:
        sql = "SELECT * FROM skike.hotel where locality = '{}' order by hotel_rating_count desc, data_query_time asc limit 1800;".format(KR_item)
            ...
            for item in sql_all_hotel_id[(20*num):(20*(num+1))]:
                ...
                try:
                    ...
                    try:
                        ...
                        rdsDB.commit()
                        print("now finish {} {} total will be {}".format(KR_item,20*num,len(sql_all_hotel_id)))
                    except Exception as e:
                        print("Exeception occured:{}".format(e))
                except Exception as e:
                        print("ERROR:", url, e)
